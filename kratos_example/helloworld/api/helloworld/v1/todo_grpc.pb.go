...
const (
	Todo_CreateTodo_FullMethodName = "/api.helloworld.v1.Todo/CreateTodo"
	Todo_UpdateTodo_FullMethodName = "/api.helloworld.v1.Todo/UpdateTodo"
	Todo_DeleteTodo_FullMethodName = "/api.helloworld.v1.Todo/DeleteTodo"
	Todo_GetTodo_FullMethodName    = "/api.helloworld.v1.Todo/GetTodo"
	Todo_ListTodo_FullMethodName   = "/api.helloworld.v1.Todo/ListTodo"
)
...
var Todo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.helloworld.v1.Todo",
